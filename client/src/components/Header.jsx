...
const Header = () => {
        ...
        return (
                ...
                >
                        ...
                        <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[760px] mx-auto mt-10 text-center'
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                transition={{ delay: 0.4, duration: 2 }}
                        >Turn Text to <span className='text-blue-600'>Image</span>, in seconds.</motion.h1>

                        <motion.p className='text-2xl text-center max-x-xl mx-auto mt-5'
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                        ...
                        <motion.button onClick={onClickHandler} className='sm:text-large text-white bg-black width-auto mt-8 px-12 py-2.5 flex item-center gap-2 rounded-full'
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        >Genrated Images from imagify</motion.p>
                </motion.div>
        )
}
